...
public class MainActivity extends AppCompatActivity {
    ...
    private void question4(){
        ...
        else if (answer4a.isChecked()){

                    answer4="A";
                }
        else if (answer4b.isChecked()){
                    answer4=answer4 +" B";
                }
        else if ( answer4c.isChecked()){

                    answer4= answer4 + " C";
                }
        else if (answer4d.isChecked()){
    ...
    private void question10(){
        ...
        else if (answer10a.isChecked()){

            answer10="A";
        }
        else if (answer10b.isChecked()){

            answer10=answer10 +" B";
        }
        else if ( answer10c.isChecked()){

            answer10= answer10 + " C";
        }
        else if (answer10d.isChecked()){
